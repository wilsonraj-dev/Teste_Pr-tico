(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('rxjs/operators'), require('@angular/fire'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/fire', '@angular/platform-browser'], factory) :
    (factory((global.angularfire2 = global.angularfire2 || {}, global.angularfire2.analytics = {}),global.ng.core,global.rxjs,global.ng.common,global.rxjs.operators,global.angularfire2,global.ng.platformBrowser));
}(this, (function (exports,core,rxjs,common,operators,fire,platformBrowser) { 'use strict';
    ...
    var AngularFireAnalytics = (function () {
        function AngularFireAnalytics(options, nameOrConfig, analyticsCollectionEnabled, providedAppVersion, providedAppName, debugModeEnabled, providedConfig, platformId, zone) {
            ...
            var analytics = rxjs.of(undefined).pipe(operators.switchMap(function () { return zone.runOutsideAngular(function () { return rxjs.empty(); }); }), operators.map(function () { return fire._firebaseAppFactory(options, zone, nameOrConfig); }), operators.map(function (app) { return app.analytics(); }), operators.tap(function (analytics) {
                if (analyticsCollectionEnabled === false) {
                    analytics.setAnalyticsCollectionEnabled(false);
                }
            }), fire.runOutsideAngular(zone), operators.shareReplay({ bufferSize: 1, refCount: false }));
    ...
    ***************************************************************************** */
    ...
    var ɵEmptyOutletComponent = /** @class */ (function () {
        ...
        ɵEmptyOutletComponent = __decorate$1([
    ...
    var RouterLink = /** @class */ (function () {
        ...
        RouterLink = __decorate$1([
            core.Directive({ selector: ':not(a):not(area)[routerLink]' }),
            __param$1(2, core.Attribute('tabindex')),
    ...
    var RouterLinkWithHref = /** @class */ (function () {
        ...
        RouterLinkWithHref = __decorate$1([
            core.Directive({ selector: 'a[routerLink],area[routerLink]' }),
            __metadata$1("design:paramtypes", [Router, ActivatedRoute,
    ...
    var RouterLinkActive = /** @class */ (function () {
        ...
        RouterLinkActive = __decorate$1([
            core.Directive({
                selector: '[routerLinkActive]',
                exportAs: 'routerLinkActive',
            }),
            __param$1(3, core.Optional()),
    ...
    var RouterOutlet = /** @class */ (function () {
        ...
        RouterOutlet = __decorate$1([
            core.Directive({ selector: 'router-outlet', exportAs: 'outlet' }),
            __param$1(3, core.Attribute('name')),
    ...
    */
    ...
    var RouterPreloader = /** @class */ (function () {
        ...
        RouterPreloader = __decorate$1([
            core.Injectable(),
            __metadata$1("design:paramtypes", [Router, core.NgModuleFactoryLoader, core.Compiler,
    ...
    var RouterModule = /** @class */ (function () {
        ...
        */
        ...
        var RouterModule_1;
        RouterModule = RouterModule_1 = __decorate$1([
            core.NgModule({
                declarations: ROUTER_DIRECTIVES,
                exports: ROUTER_DIRECTIVES,
                entryComponents: [ɵEmptyOutletComponent]
            }),
            __param$1(0, core.Optional()), __param$1(0, core.Inject(ROUTER_FORROOT_GUARD)), __param$1(1, core.Optional()),
    ...
    var RouterInitializer = /** @class */ (function () {
        ...
        RouterInitializer = __decorate$1([
            core.Injectable(),
    ...
    var ScreenTrackingService = (function () {
        ...
        ScreenTrackingService = __decorate$2([
            core.Injectable(),
            __param$2(1, core.Optional()),
    ...
    var UserTrackingService = (function () {
        function UserTrackingService(analytics, zone, platformId) {
            ...
            if (!common.isPlatformServer(platformId)) {
                zone.runOutsideAngular(function () {
                    _this.disposable = rxjs.from(import('firebase/auth')).pipe(operators.switchMap(function () { return analytics.app; }), operators.map(function (app) { return app.auth(); }), operators.switchMap(function (auth) { return new rxjs.Observable(auth.onAuthStateChanged.bind(auth)); }), operators.switchMap(function (user) { return analytics.setUserId(user ? user.uid : null); }), fire.runOutsideAngular(zone)).subscribe();
                });
            }
        }
        ...
        UserTrackingService = __decorate$2([
            core.Injectable(),
            __param$2(2, core.Inject(core.PLATFORM_ID)),
            __metadata$2("design:paramtypes", [AngularFireAnalytics,
                core.NgZone,
                Object])
        ], UserTrackingService);
    ...
    var AngularFireAnalyticsModule = (function () {
        ...
        AngularFireAnalyticsModule = __decorate$3([
            core.NgModule({
                providers: [AngularFireAnalytics]
            }),
            __param$3(1, core.Optional()),
